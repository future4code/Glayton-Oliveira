...
let valorDaDiaria = Number(prompt ("Quanto você recebe no dia?"));
alert("voce recebe", (valorDaDiaria)+(horasTrabalhadas)," por dia")*/
...
// apesar da minha variavel idade ser do tipo numero.
// isso ocorre porque eu não declarei no escopo que a minha variavel só é aceita do tipo numero.
...
let roupa = ("você está usando roupa azul hoje?");
let bebeuAgua = ("você parou pra beber água hoje?");
let estudando = ("você está estudando agora?");
let resposta1 = prompt(roupa);
let resposta2 = prompt(bebeuAgua);
let resposta3 = prompt(estudando);



console.log(roupa,"-",resposta1);
console.log(bebeuAgua,"-",resposta2);
console.log(estudando,"-",resposta3);
